...
export const goldCityStates = [' CIVILIZATION_LISBON', ' CIVILIZATION_MUSCAT', ' CIVILIZATION_ZANZIBAR', ' CIVILIZATION_ANTIOCH', ' CIVILIZATION_SAMARKAND', ' CIVILIZATION_CAHOKIA', ' CIVILIZATION_JAKARTA', ' CIVILIZATION_HUNZA'];

export const blueCityStates = [' CIVILIZATION_BOLOGNA', ' CIVILIZATION_PALENQUE', ' CIVILIZATION_TARUGA', ' CIVILIZATION_FEZ', ' CIVILIZATION_NALANDA', ' CIVILIZATION_HATTUSA', ' CIVILIZATION_GENEVA'];

export const redCityStates = [' CIVILIZATION_NGAZARGAMU', ' CIVILIZATION_PRESLAV', ' CIVILIZATION_AKKAD', ' CIVILIZATION_GRANADA', ' CIVILIZATION_WOLIN', ' CIVILIZATION_VALLETTA', ' CIVILIZATION_KABUL'];

export const whiteCityStates = [' CIVILIZATION_ARMAGH', ' CIVILIZATION_VATICAN_CITY', ' CIVILIZATION_KANDY', ' CIVILIZATION_NAZCA', ' CIVILIZATION_LA_VENTA', ' CIVILIZATION_YEREVAN', ' CIVILIZATION_JERUSALEM', ' CIVILIZATION_CHINGUETTI'];

export const orangeCityStates = [' CIVILIZATION_BRUSSELS', ' CIVILIZATION_AUCKLAND', ' CIVILIZATION_SINGAPORE', ' CIVILIZATION_JOHANNESBURG', ' CIVILIZATION_BUENOS_AIRES', ' CIVILIZATION_MEXICO_CITY', ' CIVILIZATION_HONG_KONG', ' CIVILIZATION_CARDIFF'];

export const pinkCityStates = [ ' CIVILIZATION_RAPA_NUI', ' CIVILIZATION_AYUTTHAYA', ' CIVILIZATION_MOHENJO_DARO', ' CIVILIZATION_ANTANANARIVO', ' CIVILIZATION_CAGUANA', ' CIVILIZATION_NAN_MADOL', ' CIVILIZATION_KUMASI', ' CIVILIZATION_VILNIUS'];
